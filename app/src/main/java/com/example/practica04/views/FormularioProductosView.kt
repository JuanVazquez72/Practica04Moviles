    ...
    Row(modifier = modifier) {
        ...
        OutlinedTextField(
            ...
            colors = OutlinedTextFieldDefaults.colors(
                ...
                unfocusedContainerColor = Color(0xFFE3F2FD),  // Fondo azul muy suave cuando no está enfocado
                focusedContainerColor = Color(0xFFE3F2FD)   // Fondo azul muy suave cuando está enfocado
            ),
            textStyle = TextStyle(Color.Black)  // Texto negro
        )
...
fun SelectorFecha(datePickerState: DatePickerState, selectedDate: String) {
    ...
    Box(modifier = Modifier
        ...
        OutlinedTextField(
            ...
            colors = OutlinedTextFieldDefaults.colors(
                focusedBorderColor = Color.Black,  // Borde negro cuando está enfocado
                unfocusedBorderColor = Color.Black,  // Borde negro cuando no está enfocado
                focusedContainerColor = Color(0xFFE3F2FD),  // Fondo azul claro cuando está enfocado
                unfocusedContainerColor = Color(0xFFE3F2FD)  // Fondo azul claro cuando no está enfocado
            ),
    ...
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            containerColor = colorResource(id = R.color.primaryContainerLight),
            contentColor = colorResource(id = R.color.white),
            disabledContentColor = Color.LightGray,
            disabledContainerColor = Color.LightGray
        ),
        modifier = Modifier
             // Asegura que el botón tenga un ancho completo
    ) {
        Text(
            text = "Seleccionar  Fecha de Registro",
            modifier = Modifier.padding(8.dp),  // Añadir un padding alrededor del texto
